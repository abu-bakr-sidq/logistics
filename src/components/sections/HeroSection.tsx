...
export function HeroSection() {
  ...
  return (
    <section className="relative flex h-screen w-screen snap-start items-center justify-center overflow-hidden px-6 text-white sm:px-10 md:px-16 lg:px-24">
      <style>
        {`
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-4xl flex-col items-center justify-center gap-4 pt-8 text-center sm:gap-5 md:pt-2">
        ...
        {/* High-end glassmorphic search input with cyan active halo */}
        <form
          className="flex h-14 w-full max-w-[520px] items-center justify-between rounded-full bg-white/[0.08] border border-white/15 backdrop-blur-md px-3.5 text-white shadow-[0_20px_50px_rgba(0,0,0,0.3)] transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:bg-white/[0.12] hover:border-white/25 focus-within:scale-[1.01] focus-within:border-[#27a8c4]/65 focus-within:bg-slate-900/60 focus-within:shadow-[0_0_24px_rgba(39,168,196,0.25)] sm:h-[60px] sm:max-w-[580px] sm:px-4"
